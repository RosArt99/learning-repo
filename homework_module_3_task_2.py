...
def get_numbers_ticket():
    while True: #turning on looper
        try:
            ...
            if quantity > (max - min+1): # quantity can't be less than selected range
